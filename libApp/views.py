...
def add_view(request):
    if request.method == 'GET':
        ...
        if book_id and author:
            book = BookInfo(book_id=book_id,name=name,price=price,book_type=book_type,author=author,publish_time=publish_time,publish_house=publish_house,content=content)
            book.save()
